...
ALTER TABLE "anime_season_poster_images" DROP CONSTRAINT IF EXISTS "anime_season_poster_images_season_id_fkey";

ALTER TABLE "anime_season_poster_images" DROP CONSTRAINT IF EXISTS "anime_season_poster_images_images_id_fkey";
...
DROP TABLE IF EXISTS "anime_season_poster_images";
