...
ALTER TABLE "anime_serie_seasons" DROP CONSTRAINT IF EXISTS "anime_serie_seasons_episode_id_fkey";

ALTER TABLE "anime_serie_episodes" DROP CONSTRAINT IF EXISTS "anime_serie_episodes_season_id_fkey";
ALTER TABLE "anime_serie_episodes" DROP CONSTRAINT IF EXISTS "anime_serie_episodes_server_id_fkey";

ALTER TABLE "anime_serie_servers" DROP CONSTRAINT IF EXISTS "anime_serie_servers_episode_id_fkey";
ALTER TABLE "anime_serie_servers" DROP CONSTRAINT IF EXISTS "anime_serie_servers_sub_id_fkey";
ALTER TABLE "anime_serie_servers" DROP CONSTRAINT IF EXISTS "anime_serie_servers_dub_id_fkey";
