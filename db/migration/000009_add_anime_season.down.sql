...
ALTER TABLE "anime_serie_seasons" DROP CONSTRAINT IF EXISTS "anime_serie_seasons_season_id_fkey";
...
ALTER TABLE "anime_seasons" DROP CONSTRAINT IF EXISTS "anime_seasons_anime_id_fkey";
