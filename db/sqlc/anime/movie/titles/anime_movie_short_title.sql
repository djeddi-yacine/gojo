-- name: CreateAnimeMovieShortTitle :one
INSERT INTO anime_movie_short_titles (anime_id, title_text)
VALUES ($1, $2)
RETURNING *;

-- name: QueryAnimeMovieShortTitles :many
...
-- name: GetAnimeMovieShortTitles :many
SELECT * FROM anime_movie_short_titles
WHERE anime_id = $1;

-- name: DeleteAnimeMovieShortTitle :exec
