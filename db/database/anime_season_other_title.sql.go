...
func (q *Queries) QueryAnimeSeasonOtherTitles(ctx context.Context, dollar_1 string) ([]int64, error) {
	rows, err := q.db.Query(ctx, queryAnimeSeasonOtherTitles, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
