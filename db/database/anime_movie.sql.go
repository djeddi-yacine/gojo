...
RETURNING id, unique_id, original_title, aired, release_year, rating, duration, portrait_poster, portrait_blur_hash, landscape_poster, landscape_blur_hash, show_type, created_at
`
...
SELECT id, unique_id, original_title, aired, release_year, rating, duration, portrait_poster, portrait_blur_hash, landscape_poster, landscape_blur_hash, show_type, created_at FROM anime_movies 
WHERE id = $1 LIMIT 1
`
...
SET
  ...
  show_type = COALESCE($10, show_type)
WHERE
  id = $11
RETURNING id, unique_id, original_title, aired, release_year, rating, duration, portrait_poster, portrait_blur_hash, landscape_poster, landscape_blur_hash, show_type, created_at
`
