...
func (q *Queries) QueryAnimeSeasonShortTitles(ctx context.Context, dollar_1 string) ([]int64, error) {
	rows, err := q.db.Query(ctx, queryAnimeSeasonShortTitles, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
