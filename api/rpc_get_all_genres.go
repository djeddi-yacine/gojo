...
func (server *Server) GetAllGenres(ctx context.Context, req *pb.GetAllGenresRequest) (*pb.GetAllGenresResponse, error) {
	...
	res := &pb.GetAllGenresResponse{
		Genres: PBgenres,
	}
	return res, nil
}

func validateGetAllGenresRequest(req *pb.GetAllGenresRequest) (violations []*errdetails.BadRequest_FieldViolation) {
