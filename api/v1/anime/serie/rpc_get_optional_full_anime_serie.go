...
func (server *AnimeSerieServer) GetOptionalFullAnimeSerie(ctx context.Context, req *aspbv1.GetOptionalFullAnimeSerieRequest) (*aspbv1.GetOptionalFullAnimeSerieResponse, error) {
	var err error
	...
	violations := valOptionalidateGetFullAnimeSerieRequest(req)
	if violations != nil {
	...
	res := &aspbv1.GetOptionalFullAnimeSerieResponse{}
...
func valOptionalidateGetFullAnimeSerieRequest(req *aspbv1.GetOptionalFullAnimeSerieRequest) (violations []*errdetails.BadRequest_FieldViolation) {
