...
func (server *AnimeSerieServer) CreateAnimeSerieData(ctx context.Context, req *aspbv1.CreateAnimeSerieDataRequest) (*aspbv1.CreateAnimeSerieDataResponse, error) {
	...
	res := &aspbv1.CreateAnimeSerieDataResponse{
		Episode: convertAnimeEpisode(data.Episode),
		Sub: &aspbv1.AnimeSerieSubDataResponse{
			Videos:   convertAnimeSerieVideos(data.AnimeSerieSubVideos),
			Torrents: convertAnimeSerieTorrents(data.AnimeSerieSubTorrents),
		},
		Dub: &aspbv1.AnimeSerieDubDataResponse{
			Videos:   convertAnimeSerieVideos(data.AnimeSerieDubVideos),
			Torrents: convertAnimeSerieTorrents(data.AnimeSerieDubTorrents),
		},
	}
...
func validateCreateAnimeSerieDataRequest(req *aspbv1.CreateAnimeSerieDataRequest) (violations []*errdetails.BadRequest_FieldViolation) {
