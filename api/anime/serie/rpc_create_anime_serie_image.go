...
func (server *AnimeSerieServer) CreateAnimeSerieImage(ctx context.Context, req *aspb.CreateAnimeSerieImageRequest) (*aspb.CreateAnimeSerieImageResponse, error) {
...
func validateCreateAnimeSerieImageRequest(req *aspb.CreateAnimeSerieImageRequest) (violations []*errdetails.BadRequest_FieldViolation) {
