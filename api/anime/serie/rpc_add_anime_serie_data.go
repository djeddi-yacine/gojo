...
func (server *AnimeSerieServer) AddAnimeSerieData(ctx context.Context, req *aspb.AddAnimeSerieDataRequest) (*aspb.AddAnimeSerieDataResponse, error) {
	...
	arg := db.AddAnimeSerieDataTxParams{
	...
	res := &aspb.AddAnimeSerieDataResponse{
		Episode: shared.ConvertAnimeSerieEpisode(data.Episode),
...
func validateAddAnimeSerieDataRequest(req *aspb.AddAnimeSerieDataRequest) (violations []*errdetails.BadRequest_FieldViolation) {
