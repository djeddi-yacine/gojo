...
func (server *AnimeMovieServer) AddAnimeMovieInfo(ctx context.Context, req *ampb.AddAnimeMovieInfoRequest) (*ampb.AddAnimeMovieInfoResponse, error) {
	...
	if violations := validateAddAnimeMovieInfoRequest(req); violations != nil {
		return nil, shared.InvalidArgumentError(violations)
	}

	arg := db.AddAnimeMovieInfoTxParams{
...
func validateAddAnimeMovieInfoRequest(req *ampb.AddAnimeMovieInfoRequest) (violations []*errdetails.BadRequest_FieldViolation) {
