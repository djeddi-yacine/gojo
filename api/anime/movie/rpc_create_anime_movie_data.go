...
func (server *AnimeMovieServer) CreateAnimeMovieData(ctx context.Context, req *ampb.CreateAnimeMovieDataRequest) (*ampb.CreateAnimeMovieDataResponse, error) {
	...
	if err != nil {
		return nil, shared.ApiError("failed to add anime movie videos & torrents to the server", err)
	}

	res := &ampb.CreateAnimeMovieDataResponse{
...
func validateCreateAnimeMovieDataRequest(req *ampb.CreateAnimeMovieDataRequest) (violations []*errdetails.BadRequest_FieldViolation) {
