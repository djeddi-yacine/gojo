...
type CreateAnimeMovieRequest struct {
	...
	AnimeMovie   *AnimeMovieReq   `protobuf:"bytes,1,opt,name=animeMovie,proto3" json:"animeMovie,omitempty"`
	AnimeGenres  *AnimeGenresReq  `protobuf:"bytes,2,opt,name=animeGenres,proto3,oneof" json:"animeGenres,omitempty"`
	AnimeStudios *AnimeStudiosReq `protobuf:"bytes,3,opt,name=animeStudios,proto3,oneof" json:"animeStudios,omitempty"`
	AnimeMetas   []*AnimeMetaReq  `protobuf:"bytes,4,rep,name=animeMetas,proto3" json:"animeMetas,omitempty"`
}
...
func (x *CreateAnimeMovieRequest) GetAnimeMovie() *AnimeMovieReq {
	if x != nil {
		return x.AnimeMovie
	}
	return nil
...
func (x *CreateAnimeMovieRequest) GetAnimeGenres() *AnimeGenresReq {
	if x != nil {
...
func (x *CreateAnimeMovieRequest) GetAnimeStudios() *AnimeStudiosReq {
	if x != nil {
...
func (x *CreateAnimeMovieRequest) GetAnimeMetas() []*AnimeMetaReq {
	if x != nil {
		return x.AnimeMetas
	}
	return nil
...
type CreateAnimeMovieResponse struct {
	...
	AnimeMovie *AnimeMovieRes `protobuf:"bytes,1,opt,name=animeMovie,proto3" json:"animeMovie,omitempty"`
}
...
func (x *CreateAnimeMovieResponse) GetAnimeMovie() *AnimeMovieRes {
	if x != nil {
		return x.AnimeMovie
	}
	return nil
...
var file_rpc_create_anime_movie_proto_rawDesc = []byte{
	...
	,
	...
	0x53, 0x74, 0x75, 0x64, 0x69, 0x6f, 0x73, 0x22, 0x4d, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x41, 0x6e, 0x69, 0x6d, 0x65, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x0a, 0x61, 0x6e, 0x69, 0x6d, 0x65, 0x4d, 0x6f, 0x76, 0x69,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x6e, 0x69,
	0x6d, 0x65, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x52, 0x65, 0x73, 0x52, 0x0a, 0x61, 0x6e, 0x69, 0x6d,
	0x65, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_rpc_create_anime_movie_proto_goTypes = []interface{}{
	...
	(*AnimeMovieReq)(nil),            // 2: pb.AnimeMovieReq
	(*AnimeGenresReq)(nil),           // 3: pb.AnimeGenresReq
	(*AnimeStudiosReq)(nil),          // 4: pb.AnimeStudiosReq
	(*AnimeMetaReq)(nil),             // 5: pb.AnimeMetaReq
	(*AnimeMovieRes)(nil),            // 6: pb.AnimeMovieRes
}
var file_rpc_create_anime_movie_proto_depIdxs = []int32{
	2, // 0: pb.CreateAnimeMovieRequest.animeMovie:type_name -> pb.AnimeMovieReq
	3, // 1: pb.CreateAnimeMovieRequest.animeGenres:type_name -> pb.AnimeGenresReq
	4, // 2: pb.CreateAnimeMovieRequest.animeStudios:type_name -> pb.AnimeStudiosReq
	5, // 3: pb.CreateAnimeMovieRequest.animeMetas:type_name -> pb.AnimeMetaReq
	6, // 4: pb.CreateAnimeMovieResponse.animeMovie:type_name -> pb.AnimeMovieRes
