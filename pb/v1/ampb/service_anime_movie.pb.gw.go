...
func request_AnimeMovieService_CreateAnimeMovieCharacters_0(ctx context.Context, marshaler runtime.Marshaler, client AnimeMovieServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateAnimeMovieCharactersRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.CreateAnimeMovieCharacters(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AnimeMovieService_CreateAnimeMovieCharacters_0(ctx context.Context, marshaler runtime.Marshaler, server AnimeMovieServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateAnimeMovieCharactersRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreateAnimeMovieCharacters(ctx, &protoReq)
	return msg, metadata, err
...
var (
	filter_AnimeMovieService_GetFullAnimeMovie_0 = &utilities.DoubleArray{Encoding: map[string]int{"animeID": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	filter_AnimeMovieService_GetOptionalFullAnimeMovie_0 = &utilities.DoubleArray{Encoding: map[string]int{"animeID": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_AnimeMovieService_GetOptionalFullAnimeMovie_0(ctx context.Context, marshaler runtime.Marshaler, client AnimeMovieServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetOptionalFullAnimeMovieRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AnimeMovieService_GetOptionalFullAnimeMovie_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetOptionalFullAnimeMovie(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AnimeMovieService_GetOptionalFullAnimeMovie_0(ctx context.Context, marshaler runtime.Marshaler, server AnimeMovieServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetOptionalFullAnimeMovieRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetOptionalFullAnimeMovie(ctx, &protoReq)
	return msg, metadata, err
...
func request_AnimeMovieService_GetAnimeMovieCharacters_0(ctx context.Context, marshaler runtime.Marshaler, client AnimeMovieServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetAnimeMovieCharactersRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetAnimeMovieCharacters(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AnimeMovieService_GetAnimeMovieCharacters_0(ctx context.Context, marshaler runtime.Marshaler, server AnimeMovieServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetAnimeMovieCharactersRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetAnimeMovieCharacters(ctx, &protoReq)
	return msg, metadata, err

}

var (
	filter_AnimeMovieService_QueryAnimeMovie_0 = &utilities.DoubleArray{Encoding: map[string]int{"query": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func RegisterAnimeMovieServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AnimeMovieServiceServer) error {
	...
	mux.Handle("POST", pattern_AnimeMovieService_CreateAnimeMovieCharacters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.ampbv1.AnimeMovieService/CreateAnimeMovieCharacters", runtime.WithHTTPPathPattern("/anime/movie/character/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AnimeMovieService_CreateAnimeMovieCharacters_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AnimeMovieService_CreateAnimeMovieCharacters_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_AnimeMovieService_GetOptionalFullAnimeMovie_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.ampbv1.AnimeMovieService/GetOptionalFullAnimeMovie", runtime.WithHTTPPathPattern("/anime/movie/optional/{animeID}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AnimeMovieService_GetOptionalFullAnimeMovie_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AnimeMovieService_GetOptionalFullAnimeMovie_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_AnimeMovieService_GetAnimeMovieImages_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.ampbv1.AnimeMovieService/GetAnimeMovieImages", runtime.WithHTTPPathPattern("/anime/movie/{animeID}/image"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AnimeMovieService_GetAnimeMovieCharacters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.ampbv1.AnimeMovieService/GetAnimeMovieCharacters", runtime.WithHTTPPathPattern("/anime/movie/{animeID}/character"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AnimeMovieService_GetAnimeMovieCharacters_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AnimeMovieService_GetAnimeMovieCharacters_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAnimeMovieServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AnimeMovieServiceClient) error {
	...
	mux.Handle("POST", pattern_AnimeMovieService_CreateAnimeMovieCharacters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v1.ampbv1.AnimeMovieService/CreateAnimeMovieCharacters", runtime.WithHTTPPathPattern("/anime/movie/character/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AnimeMovieService_CreateAnimeMovieCharacters_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_AnimeMovieService_GetOptionalFullAnimeMovie_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v1.ampbv1.AnimeMovieService/GetOptionalFullAnimeMovie", runtime.WithHTTPPathPattern("/anime/movie/optional/{animeID}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AnimeMovieService_GetOptionalFullAnimeMovie_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_AnimeMovieService_GetAnimeMovieImages_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v1.ampbv1.AnimeMovieService/GetAnimeMovieImages", runtime.WithHTTPPathPattern("/anime/movie/{animeID}/image"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AnimeMovieService_GetAnimeMovieCharacters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v1.ampbv1.AnimeMovieService/GetAnimeMovieCharacters", runtime.WithHTTPPathPattern("/anime/movie/{animeID}/character"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AnimeMovieService_GetAnimeMovieCharacters_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_AnimeMovieService_CreateAnimeMovieCharacters_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"anime", "movie", "character", "create"}, ""))
	...
	pattern_AnimeMovieService_GetOptionalFullAnimeMovie_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"anime", "movie", "optional", "animeID"}, ""))

	pattern_AnimeMovieService_GetAnimeMovieImages_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"anime", "movie", "animeID", "image"}, ""))

	pattern_AnimeMovieService_GetAnimeMovieCharacters_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"anime", "movie", "animeID", "character"}, ""))
...
var (
	...
	forward_AnimeMovieService_CreateAnimeMovieCharacters_0 = runtime.ForwardResponseMessage
	...
	forward_AnimeMovieService_GetOptionalFullAnimeMovie_0 = runtime.ForwardResponseMessage

	forward_AnimeMovieService_GetAnimeMovieImages_0 = runtime.ForwardResponseMessage

	forward_AnimeMovieService_GetAnimeMovieCharacters_0 = runtime.ForwardResponseMessage
