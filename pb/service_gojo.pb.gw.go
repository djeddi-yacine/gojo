...
func request_Gojo_GetAnimeMovieImages_0(ctx context.Context, marshaler runtime.Marshaler, client GojoClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ampb.GetAnimeMovieImagesRequest
	var metadata runtime.ServerMetadata
...
func local_request_Gojo_GetAnimeMovieImages_0(ctx context.Context, marshaler runtime.Marshaler, server GojoServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ampb.GetAnimeMovieImagesRequest
	var metadata runtime.ServerMetadata
...
func RegisterGojoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GojoServer) error {
	...
	mux.Handle("GET", pattern_Gojo_GetAnimeMovieImages_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.Gojo/GetAnimeMovieImages", runtime.WithHTTPPathPattern("/v1/anime/movie/{animeID}/images"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Gojo_GetAnimeMovieImages_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Gojo_GetAnimeMovieImages_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGojoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GojoClient) error {
	...
	mux.Handle("GET", pattern_Gojo_GetAnimeMovieImages_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.Gojo/GetAnimeMovieImages", runtime.WithHTTPPathPattern("/v1/anime/movie/{animeID}/images"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Gojo_GetAnimeMovieImages_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Gojo_GetAnimeMovieImages_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "anime", "movie", "animeID", "images"}, ""))
...
var (
	...
	forward_Gojo_GetAnimeMovieImages_0 = runtime.ForwardResponseMessage
