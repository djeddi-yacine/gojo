...
// 	protoc        v4.24.4
// source: aspb/rpc_add_info_anime_serie.proto
...
func (x *AddInfoAnimeSerieRequest) Reset() {
	*x = AddInfoAnimeSerieRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_aspb_rpc_add_info_anime_serie_proto_msgTypes[0]
...
func (*AddInfoAnimeSerieRequest) Descriptor() ([]byte, []int) {
	return file_aspb_rpc_add_info_anime_serie_proto_rawDescGZIP(), []int{0}
}
...
func (x *AddInfoAnimeSerieRequest) GetGenres() *nfpb.AnimeGenresRequest {
	if x != nil {
		return x.Genres
	}
	return nil
...
func (x *AddInfoAnimeSerieRequest) GetStudios() *nfpb.AnimeStudiosRequest {
	if x != nil {
		return x.Studios
	}
	return nil
...
func (x *AddInfoAnimeSerieResponse) Reset() {
	*x = AddInfoAnimeSerieResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_aspb_rpc_add_info_anime_serie_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AddInfoAnimeSerieResponse) Descriptor() ([]byte, []int) {
	return file_aspb_rpc_add_info_anime_serie_proto_rawDescGZIP(), []int{1}
}
...
func (x *AddInfoAnimeSerieResponse) GetGenres() *nfpb.AnimeGenresResponse {
	if x != nil {
		return x.Genres
	}
	return nil
...
func (x *AddInfoAnimeSerieResponse) GetStudios() *nfpb.AnimeStudiosResponse {
	if x != nil {
		return x.Studios
	}
	return nil
...
var File_aspb_rpc_add_info_anime_serie_proto protoreflect.FileDescriptor

var file_aspb_rpc_add_info_anime_serie_proto_rawDesc = []byte{
	0x0a, 0x23, 0x61, 0x73, 0x70, 0x62, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x61, 0x64, 0x64, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x5f, 0x61, 0x6e, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x69, 0x65, 0x2e,
	...
	0x66, 0x6f, 0x41, 0x6e, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x69, 0x65, 0x52, 0x65, 0x73, 0x70,
...
var (
	file_aspb_rpc_add_info_anime_serie_proto_rawDescOnce sync.Once
	file_aspb_rpc_add_info_anime_serie_proto_rawDescData = file_aspb_rpc_add_info_anime_serie_proto_rawDesc
)

func file_aspb_rpc_add_info_anime_serie_proto_rawDescGZIP() []byte {
	file_aspb_rpc_add_info_anime_serie_proto_rawDescOnce.Do(func() {
		file_aspb_rpc_add_info_anime_serie_proto_rawDescData = protoimpl.X.CompressGZIP(file_aspb_rpc_add_info_anime_serie_proto_rawDescData)
	})
	return file_aspb_rpc_add_info_anime_serie_proto_rawDescData
}

var file_aspb_rpc_add_info_anime_serie_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_aspb_rpc_add_info_anime_serie_proto_goTypes = []interface{}{
	(*AddInfoAnimeSerieRequest)(nil),  // 0: aspb.AddInfoAnimeSerieRequest
	(*AddInfoAnimeSerieResponse)(nil), // 1: aspb.AddInfoAnimeSerieResponse
...
var file_aspb_rpc_add_info_anime_serie_proto_depIdxs = []int32{
	2, // 0: aspb.AddInfoAnimeSerieRequest.genres:type_name -> nfpb.AnimeGenresRequest
	3, // 1: aspb.AddInfoAnimeSerieRequest.studios:type_name -> nfpb.AnimeStudiosRequest
	4, // 2: aspb.AddInfoAnimeSerieResponse.animeSerie:type_name -> aspb.AnimeSerieResponse
	5, // 3: aspb.AddInfoAnimeSerieResponse.genres:type_name -> nfpb.AnimeGenresResponse
	6, // 4: aspb.AddInfoAnimeSerieResponse.studios:type_name -> nfpb.AnimeStudiosResponse
...
func init() { file_aspb_rpc_add_info_anime_serie_proto_init() }
func file_aspb_rpc_add_info_anime_serie_proto_init() {
	if File_aspb_rpc_add_info_anime_serie_proto != nil {
		return
	}
	file_aspb_anime_serie_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_aspb_rpc_add_info_anime_serie_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aspb_rpc_add_info_anime_serie_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_aspb_rpc_add_info_anime_serie_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_aspb_rpc_add_info_anime_serie_proto_goTypes,
		DependencyIndexes: file_aspb_rpc_add_info_anime_serie_proto_depIdxs,
		MessageInfos:      file_aspb_rpc_add_info_anime_serie_proto_msgTypes,
	}.Build()
	File_aspb_rpc_add_info_anime_serie_proto = out.File
	file_aspb_rpc_add_info_anime_serie_proto_rawDesc = nil
	file_aspb_rpc_add_info_anime_serie_proto_goTypes = nil
	file_aspb_rpc_add_info_anime_serie_proto_depIdxs = nil
}
